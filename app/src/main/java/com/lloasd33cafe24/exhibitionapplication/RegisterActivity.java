    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String adminID = idText.getText().toString();
                String adminPassword = passwordText.getText().toString();
                ...
                RegisterRequest registerRequest = new RegisterRequest(adminID, adminPassword, adminEmail, responseListener);
